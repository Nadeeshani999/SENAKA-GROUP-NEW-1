...
/* ═══════════════════════════════════════════════
   ...
   Bank dropdown REMOVED — Company filter only
═══════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════
   ...
   CHANGES v6.3:
   • Removed: fin-donut (Portfolio Breakdown)
   • Removed: fin-stacked (Repayment Progress)
   • fin-bar (Outstanding by Lender) is now full-width
     with a Bank Name dropdown filter
   • fin-monthly changed from donut → bar chart
═══════════════════════════════════════════════ */
async function initFinancePage() {
  ...
  /* ── Populate Bank Name dropdown from real data ── */
  ...
  /* ── Outstanding by Lender bar chart (filterable) ── */
  ...
  /* ── Monthly Obligations bar chart (by loan type) ── */
  ...
  /* ── Wire Bank Name dropdown → re-draw Outstanding chart only ── */
